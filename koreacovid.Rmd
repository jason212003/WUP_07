...
## Conclusions
In today's lesson i learned to do a ggplot with the helper file. I change the class for result and name the project kRdata. I was also able to create a numerical graph in % and counting. I also run a Chi-square test and a fisher test and both are equal in p value. The final result is that we want to know what the odds are of this happening. All male are the ones who suffered more during this study. Female had an advantage over male.
